...
public:
	Slider();
	Slider(float width, float length);
	/// <summary>
///  confort constructor
/// </summary>
...
/// <returns> None</returns>
	Slider(AssetManager* a, sf::Vector2f pos, sf::Vector2f size, std::string nameOfSlider);

	Slider(AssetManager* a, sf::Vector2f size, std::string nameOfSlider);
