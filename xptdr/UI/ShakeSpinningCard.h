...
{
private:
    Carousel::cardHandler* m_spinningCard;
...
public:
    ...
    ShakeSpinningCard(Carousel::cardHandler* spinningCard,float* timer_): m_spinningCard(spinningCard), m_shakeIntensity(0.f), m_shakeDuration(0.f), m_shakeElapsedTime(0.f),
