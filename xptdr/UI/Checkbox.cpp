...
Checkbox::Checkbox(AssetManager* a, sf::Vector2f pos, std::string titleOftheCheckbox, unsigned int charSize)
	:Checkbox(a,titleOftheCheckbox,charSize)
{
	setPosition(pos);
}

Checkbox::Checkbox(AssetManager* a, std::string titleOftheCheckbox, unsigned int charSize)
{
	isSelected = true;
	asset = a;
