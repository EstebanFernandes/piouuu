...
Button::Button(AssetManager* a, std::string title, float xSize, float ySize)
 : Button(a,xSize,ySize)
{
	setString(title);
}

Button::Button(AssetManager* a, float xSizeParam, float ySizeParam)
	:Button(a)
{
	setPosition(0, 0);
...
void Button::setSize(float xSizeParam, float ySizeParam)
{
	xSize = xSizeParam;
	ySize = ySizeParam;
...
void Button::setPosition(float xParam, float yParam)
{
...
void Button::setFontColor(sf::Color colorParam)
{
	text.setFillColor(colorParam);
}

void Button::setOutlineThickness(float fParam)
{
	back.setOutlineThickness(fParam);
}

void Button::setThicknessColor(sf::Color colorParam)
{
	back.setOutlineColor(colorParam);
}

void Button::setString(std::string strParam)
{
...
void Button::setScale(sf::Vector2f scale)
{
	...
	text.setScale(scale);
	UI::setPosition(back.getPosition());
}
...
void Button::resizeText(sf::Text& textToResize)
{
