...
const sf::IntRect bouton::pasEnfonce = sf::IntRect(0, 0, 11, 12);
const sf::IntRect bouton::Enfonce = sf::IntRect(11, 1, 11, 11);
CCommentJouer::CCommentJouer(GameDataRef data_)
	: data(data_)
{
}

void CCommentJouer::initAssets()
{
...
void CCommentJouer::STEInit()
{
	...
	fond.setSize(sf::Vector2f(data->assets.getEcranBound()));
	...
	joystick.anim = CAnimation(&joystick.sprite, sf::Vector2i(20, 20), 9, -1.f, 2);
...
void CCommentJouer::STEDraw(float delta)
{
