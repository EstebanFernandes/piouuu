...
public:
	...
	Animation(sf::Sprite* sprit,sf::Vector2i textframe, sf::Vector2i nbframe,float time,int pxbFrame = 0) : 
	...
	Animation(sf::Sprite* sprit, sf::Vector2i frame, int nbframe, float time, int pxbFrame = 0)
		:Animation(sprit,frame,sf::Vector2i(nbframe,1),time,pxbFrame)
	{
	}
