...
/// </summary>
class Enemy : public HittingEntity
{
protected:
	...
	sf::Clock hitClock;
	/// <summary>
	/// Cette fonction set les informations de la classe Enemy.
	/// </summary>
	/// <param name="a"></param>
	/// <param name="info"></param>
	/// <param name="nameParam"></param>
	void initEnnemy(AssetManager* a,enemyInfo info, std::string nameParam = "");
	void initEnnemy(AssetManager* a, std::string nameParam = "");
	void initEnnemy(AssetManager* a,sf::Vector2f , std::string nameParam = "");
	/// <summary>
	/// DEPRECATED
	/// </summary>
	/// <param name="a"></param>
	...
	void initEnnemy(AssetManager* a, std::string nameParam, sf::Vector2f scale);
public:
	bool onAvance = true;
	void initAnimation();
	void initStat() {
	...
	void specialBehaviorwithPlayer(Player& player);
	...
	virtual void initPosition()
	{
		...
		{
			spawnPos.x = (float)Engine::SCREEN_WIDTH;
		...
		{
				int a = Engine::SCREEN_WIDTH - (int)getGlobalBounds().height;
		...
		{
			spawnPos.y = (float)Engine::SCREEN_HEIGHT;
		...
		{
			int a = Engine::SCREEN_HEIGHT - (int)getGlobalBounds().height;
