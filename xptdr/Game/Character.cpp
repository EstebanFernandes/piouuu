#include "Character.h"
#include<string>
Character::Character(std::string imagePathParam, std::string nameParam, std::string descriptionParam, bool animated)
{
...
void Character::setCharacterStats(float maxHealthPointParam, float moveSpeedParam, int canonNumberParam, int damagePerBulletParam, float attackSpeedParam, float BulletSpeedParam)
{
...
void Character::setCharacterStats(Character ch)
{
...
bool Character::matchTypewithValue(std::string type, std::string value)
{
...
/// <returns></returns>
std::string Character::returnTypeStylish(std::string type, std::string value)
{
...
std::string Character::getImageName()
{
	return imageName;
}
