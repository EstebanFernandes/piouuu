...
**************************************************************************************************************/
Exception::Exception(unsigned int valeur)
{
	uiEXCvaleur = valeur;
}
...
*******************************************************************************/
void Exception::EXCModifierValeur(unsigned int value)
{
	uiEXCvaleur = value;
}
...
****************************************************************************************/
inline unsigned int Exception::EXCLireValeur()
{
	return uiEXCvaleur;
}
...
*********************************************************************/
void Exception::EXCHandleException()
{
	switch (uiEXCvaleur)
	{
