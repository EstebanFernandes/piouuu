...
private:
	...
	float* clock;
	float offset = 0.f;
	std::vector<HittingEntity*>* ennemyList;
	bool isRandom = false;
	/// <summary>
...
public:
	...
	/// </summary>
	/// <param name="it"></param>
	void deleteEnemy(HittingEntity* entity);
	void startLevel();
	//Getter et setter
	void setEnnemyList(std::vector<HittingEntity*>* ennemyList_) { ennemyList = ennemyList_; }
