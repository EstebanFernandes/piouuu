...
//Heritage of Entity and Character, basic class to handle mob (entity with life bar and stats)
class Mob : public Entity, public Character
{
protected :
...
public:
	...
	Mob();
	void updateStates(Character characterParam);
	...
	sf::Vector2f getDistance(Mob& player) {
