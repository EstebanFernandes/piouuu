...
#define Tir = false
#define nbAim 6
class Gunslinger : public Weapon
{
protected:
	...
	//void initBuff(BulletAuto& ref);
	void setAnimation(BulletAuto& ref);
	//This method return a new allocated bullet based on typeBullet
	Bullet* getAllocatedBullet();
public:
	...
	void setWeaponStats(WeaponStat statsParam);
	...
	//std::list<BulletAuto>& getReferenceList() { return magasine; }
	 
	 std::list<Bullet*>& getReferenceList() { return bullets; }
	...
	void addByIndex(BulletAuto&,int index);
