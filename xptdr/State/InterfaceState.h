...
namespace StateNS
{
	...
	/// <summary>
	/// Interface that implement method useful for State inherit
	/// </summary>
	...
	public:
		...
		/// <returns></returns>
		int getLargestCharSize(std::vector<UI*>& uiList) {
		...
		int getMinCharSize(std::vector<UI*>& uiList) {
		...
		/// </summary>
		/// <param name="buttonlist"></param>
		void applymaxMinCharSize(std::vector<UI*>& uiList)
		{
		...
		/// <returns></returns>
		static int getCardMinCharSize(std::vector<CardUpgrade>& uiList,int type = 0) {
		...
		/// </summary>
		/// <param name="buttonlist"></param>
		static void applyCardUpgrademaxMinCharSize(std::vector<CardUpgrade>& uiList)
		{
			for (int i = 0; i < 3; i++)
			{
		...
		static int getMinCharSize(std::vector<Card>& cards, int part)
		{
